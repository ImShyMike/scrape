export const faqs = [
	...
	},
	{
		...
		a: '<span class="font-title text-3xl sm:text-4xl">scrape</span> is running until August 20th at 11:59pm EDT! <a href="https://time.cs50.io/20260820T1300-1559?title=scraper+YSWS+deadline" target="_blank" rel="noopener noreferrer" class="underline">(timezone converter)</a>'
	},
	{
		q: 'What is a YSWS?',
	...
	},
	{
		...
		a: 'Send them in the Slack at <a href="https://app.slack.com/client/E09V59WQY1E/C0BR3PBD61J" target="_blank" rel="noopener noreferrer" class="underline">#scrape</a>'
	}
];
