export const faqs = [
	...
	},
	{
		...
		a: '<span class="font-title text-3xl sm:text-4xl">scrape</span> is running until August 20th at 2pm EDT! <a href="https://time.cs50.io/20260820T1300-0500?title=scraper+YSWS+deadline" target="_blank" rel="noopener noreferrer" class="underline">(timezone converter)</a>'
	},
	{
		q: 'What is a YSWS?',
